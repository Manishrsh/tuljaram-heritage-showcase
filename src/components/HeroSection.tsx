  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img src={heroImg} alt="Traditional Maharashtrian Gold Jewelry by Tuljaram Saraf" className="w-full h-full object-cover" />
        <div className="absolute inset-0 bg-gradient-to-b from-foreground/70 via-foreground/50 to-foreground/80" />
      </div>

      {/* Content */}
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        <p className="font-accent text-sm md:text-base tracking-[0.4em] uppercase text-gold-light mb-6 animate-fade-in" style={{ animationDelay: '0.2s', opacity: 0 }}>
          Since Generations • Ichalkaranji
        </p>
